...
/**
 * MapReduce program Lab4 - normalized avarage rating
 */
public class DriverBigData extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJobName("Lab#4 - normalizing ratings - step 1");
		...
		inputPath = new Path(args[1]); //input
		outputDir = new Path(args[2]); //output1
		...
		if (job.waitForCompletion(true) == true) {
			...
			job2.setJobName("Lab#4 - normalized average rating - step 2");
